...
public class follow2 : MonoBehaviour
{
    ...
    [SerializeField]
    private PhysicsMaterial2D LittleFriction;
    [SerializeField]
    ...
    private void slopeCheckVertical(Vector2 checkPos)
    {
        ...
        {   
            _rigidbody.sharedMaterial = LittleFriction;
    ...
    void LateUpdate()
    {
        ...
        else if (isGrounded && isOnSlope && canWalkOnSlope) //If on slope
        {
            ...
            //try put a number to replace -xinput -1 and 0 when the player and the ai is one block away the number become 0
